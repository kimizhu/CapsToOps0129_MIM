...
| **MIM CM** (Server and CA integration) | Windows server | Windows Server 2008 R2 SP1<br/>Windows Server 2012 R2 |
...
| **MIM CM** (Application) | Windows | Windows 8<br/>Windows 8.1<br/>Windows 10 |
| **MIM CM** (Client and Bulk Client) | Windows | Windows 7 |
